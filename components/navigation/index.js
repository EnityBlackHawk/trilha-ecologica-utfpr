...
export default function NavigationView() {
  ...
  return (
    <View style={styles.container}>
      ...
      <NavCard title={"Ler QR Code"} text={"Aprenda sobre a fauna e a flora"} svg={qr_icon}/>
      <NavCard title={"Cards"} text={""} svg={card_icon}/>
      <NavCard title={"Fotos"} text={"Poste suas fotos da trilha"} svg={photos_icon}/>
      <NavCard title={"Feedback"} text={"Fale sua experiencia na trilha"} svg={feedback_icon}/>
